const CACHE_NAME = 'rhine-lab-pages-v133-0.2.6';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260830-14',
    ...
    './css/rhine-lab-mobile.css?v=0.2.6d',
    ...
    './js/rhine-lab-bootstrap.js?v=0.2.6d',
    './js/rhine-lab.js?v=0.2.6d',
