const CACHE_NAME = 'rhine-lab-pages-v139-0.2.6';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260831-5',
    ...
    './css/rhine-lab-mobile.css?v=0.2.6h',
    './js/rhine-lab-config.js?v=0.2.6',
    './js/rhine-lab-i18n.js?v=0.2.6h',
    ...
    './js/rhine-lab-bootstrap.js?v=0.2.6i',
    './js/rhine-lab.js?v=0.2.6i',
