const CACHE_NAME = 'rhine-lab-pages-v140-0.2.6';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260831-6',
    ...
    './js/rhine-lab-bootstrap.js?v=0.2.6j',
    './js/rhine-lab.js?v=0.2.6j',
