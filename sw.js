const CACHE_NAME = 'rhine-lab-pages-v141-0.2.6';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260831-7',
    ...
    './css/rhine-lab-mobile.css?v=0.2.6i',
    './js/rhine-lab-config.js?v=0.2.6',
    './js/rhine-lab-i18n.js?v=0.2.6j',
    ...
    './js/rhine-lab-bootstrap.js?v=0.2.6k',
    './js/rhine-lab.js?v=0.2.6k',
