const CACHE_NAME = 'rhine-lab-pages-v115-0.2.4';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260829-1',
    ...
    './css/rhine-lab-workflow-refine.css?v=0.2.4g',
    './css/rhine-lab-biology.css?v=0.2.4i',
    './css/rhine-lab-bioinformatics.css?v=0.2.4p',
    './css/rhine-lab-assistant.css?v=0.2.4c',
    './css/rhine-lab-motion-icons.css?v=0.2.4g',
    './css/rhine-lab-mobile.css?v=0.2.4a',
    './js/rhine-lab-config.js?v=0.2.4-ai-ready',
    './js/rhine-lab-i18n.js?v=0.2.4m',
    './js/rhine-lab-crypto.js?v=0.1.9-storage-recovery',
    './js/rhine-lab-sync-v019.js?v=0.2.4-usb-tether',
    './js/rhine-lab-pwa.js?v=0.2.4g',
    './js/rhine-lab-assistant.js?v=0.2.4e',
    './js/rhine-lab-bootstrap.js?v=0.2.4t',
    './js/rhine-lab.js?v=0.2.4t',
    './data/showcase.json',
    './images/rhine-life-logo.png',
    './images/rhine-life-app-icon.png?v=0.2.4',
