const CACHE_NAME = 'rhine-lab-pages-v124-0.2.4';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    ...
    './js/rhine-lab-assistant.js?v=0.2.4h',
    './js/rhine-lab-bootstrap.js?v=0.2.4x',
    './js/rhine-lab.js?v=0.2.4x',
