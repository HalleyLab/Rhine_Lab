const CACHE_NAME = 'rhine-lab-pages-v117-0.2.4';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260829-3',
    ...
    './css/rhine-lab-mobile.css?v=0.2.4c',
    './js/rhine-lab-config.js?v=0.2.4-ai-ready',
    './js/rhine-lab-i18n.js?v=0.2.4o',
    ...
    './js/rhine-lab-bootstrap.js?v=0.2.4v',
    './js/rhine-lab.js?v=0.2.4v',
    './js/rhine-lab-utility-icon.js?v=0.2.4a',
