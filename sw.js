...
const APP_SHELL = [
    ...
    './css/rhine-lab-v019.css?v=0.2.3-usb-tether',
    ...
    './css/rhine-lab-biology.css?v=0.2.3i',
    './css/rhine-lab-bioinformatics.css?v=0.2.3p',
    './css/rhine-lab-assistant.css?v=0.2.3c',
    './css/rhine-lab-motion-icons.css?v=0.2.3g',
    './js/rhine-lab-config.js?v=0.2.3-ai-ready',
    './js/rhine-lab-i18n.js?v=0.2.3m',
    './js/rhine-lab-crypto.js?v=0.1.9-storage-recovery',
    './js/rhine-lab-sync-v019.js?v=0.2.3-usb-tether',
