const CACHE_NAME = 'rhine-lab-pages-v130-0.2.6';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260830-11',
    ...
    './css/rhine-lab-mobile.css?v=0.2.6a',
    ...
    './js/rhine-lab-bootstrap.js?v=0.2.6a',
    './js/rhine-lab.js?v=0.2.6a',
