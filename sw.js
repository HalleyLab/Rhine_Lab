const CACHE_NAME = 'rhine-lab-pages-v116-0.2.4';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260829-2',
    ...
    './css/rhine-lab-assistant.css?v=0.2.4d',
    './css/rhine-lab-motion-icons.css?v=0.2.4g',
    './css/rhine-lab-mobile.css?v=0.2.4b',
    './js/rhine-lab-config.js?v=0.2.4-ai-ready',
    './js/rhine-lab-i18n.js?v=0.2.4n',
    ...
    './js/rhine-lab-bootstrap.js?v=0.2.4u',
    './js/rhine-lab.js?v=0.2.4u',
    './data/showcase.json',
