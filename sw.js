const CACHE_NAME = 'rhine-lab-pages-v135-0.2.6';
const APP_SHELL = [
    './',
    './index.html',
    './app.webmanifest',
    './css/rhine-lab.css?v=20260831-2',
    ...
    './css/rhine-lab-mobile.css?v=0.2.6e',
    './js/rhine-lab-config.js?v=0.2.6',
    './js/rhine-lab-i18n.js?v=0.2.6e',
    ...
    './js/rhine-lab-bootstrap.js?v=0.2.6f',
    './js/rhine-lab.js?v=0.2.6f',
