...
下载：Android 使用 `Rhine-Lab-0.2.0-Android.apk`；Windows 使用 `Rhine-Lab-0.2.0-Windows-Setup.exe`。应用启动后会联网检查 GitHub 最新正式版本，并在更新前征求确认。
...
Downloads: `Rhine-Lab-0.2.0-Android.apk` for Android or `Rhine-Lab-0.2.0-Windows-Setup.exe` for Windows. On launch, the apps check the latest stable GitHub release and ask before updating.
