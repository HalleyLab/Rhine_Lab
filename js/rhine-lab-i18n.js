(function () {
    ...
    const english = Object.freeze({
        ...
        'Rhine Lab 生命科学实验管理工作台：实验记录、动物、试剂、样本、细胞维持与实验日程。': 'Rhine Lab life-science workspace for experiments, animals, reagents, samples, cell maintenance and schedules.',
        ...
        '实验记录、动物管理、试剂库存、样本库、细胞维持与实验日程的一体化科研工作台。': 'An integrated research workspace for experiment records, animal management, reagent inventory, biobanking, cell maintenance and schedules.',
        ...
        '已填写结果': 'Completed results',
        '待填写结果': 'Pending results',
        ...
        '1 小时前': '1 hour ago',
        '2 小时前': '2 hours ago',
        '细胞维持': 'Cell Maintenance',
        '细胞培养台账': 'Cell culture registry',
        '/ 细胞培养台账': '/ CULTURE REGISTRY',
        '集中记录正在培养的细胞、培养容器、代次、汇合度和每一次传代操作。': 'Track maintained cells, culture vessels, passages, confluence and every culture operation.',
        ...
        '尚未登记培养中的细胞': 'No maintained cells registered',
