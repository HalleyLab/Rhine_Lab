(function () {
    ...
    const english = Object.freeze({
        ...
        'Rhine Lab 生命科学实验管理工作台：实验记录、动物、试剂、样本、细胞维持与实验日程。': 'Rhine Lab life-science workspace for experiment records, animal housing, reagent inventory, biobanking, cell culture and scheduling.',
        ...
        '实验记录、动物管理、试剂库存、样本库、细胞维持与实验日程的一体化科研工作台。': 'An integrated research workspace for experiment records, animal management, reagent inventory, biobanking, cell culture and scheduling.',
        ...
        '所有字段均可留空；系统会自动生成内部编号，之后可继续编辑补充。': 'All fields may be left blank. An internal ID will be generated so the record can be completed later.',
    ...
    const patterns = [
        ...
        [/^(\d+) 条记录$/, function (m) { return m[1] + ' records'; }],
        [/^(\d+) 条实验记录$/, function (m) { return m[1] + ' experiment records'; }],
        [/^(\d+) 个附件$/, function (m) { return m[1] + ' attachments'; }],
