...
assert.match(html, /rhine-lab-motion-icons\.css\?v=0\.3\.3/);
assert.match(worker, /rhine-lab-motion-icons\.css\?v=0\.3\.3/);
assert.match(worker, /rhine-lab-close-icons\.js\?v=0\.3\.3/);
