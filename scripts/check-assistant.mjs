...
assert.match(html, /rhine-lab-assistant\.css\?v=0\.2\.6/);
assert.match(html, /rhine-lab-assistant\.js\?v=0\.2\.6/);
...
assert.match(worker, /rhine-lab-assistant\.css\?v=0\.2\.6/);
assert.match(worker, /rhine-lab-mobile\.css\?v=0\.2\.6/);
assert.match(worker, /rhine-lab-assistant\.js\?v=0\.2\.6/);
