...
assert.match(html, /rhine-lab-assistant\.js\?v=0\.2\.4h/);
...
assert.match(worker, /rhine-lab-assistant\.js\?v=0\.2\.4h/);
...
assert.match(main, /<section class="experiment-inline-result completed"><strong class="result-recorded">已录入结果<\/strong><\/section>/);
