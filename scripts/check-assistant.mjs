...
assert.match(html, /rhine-lab-assistant\.css\?v=0\.3\.1/);
assert.match(html, /rhine-lab-assistant\.js\?v=0\.3\.1/);
...
assert.match(worker, /rhine-lab-assistant\.css\?v=0\.3\.1/);
assert.match(worker, /rhine-lab-mobile\.css\?v=0\.3\.1/);
assert.match(worker, /rhine-lab-assistant\.js\?v=0\.3\.1/);
