...
assert.match(worker, /rhine-lab-mobile\.css\?v=0\.2\.5c/);
assert.match(worker, /rhine-lab-assistant\.js\?v=0\.2\.5c/);
...
assert.match(main, /data-cold-storage-layout/);
...
assert.match(html, /id="coldStorageTabs"[\s\S]*data-add="coldStorage"[\s\S]*id="coldStorageRoomMap"/);
