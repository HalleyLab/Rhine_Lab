...
assert.match(html, /rhine-lab-assistant\.css\?v=0\.3\.2-ai5/);
assert.match(html, /rhine-lab-assistant\.js\?v=0\.3\.2-ai5/);
...
assert.match(worker, /rhine-lab-assistant\.css\?v=0\.3\.2-ai5/);
assert.match(worker, /rhine-lab-mobile\.css\?v=0\.3\.2-web4/);
assert.match(worker, /rhine-lab-assistant\.js\?v=0\.3\.2-ai5/);
